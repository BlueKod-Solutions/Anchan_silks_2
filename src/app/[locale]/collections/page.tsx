      ...
      <main className="min-h-screen bg-cream-50 pt-20">
              ...
              {filters.map(({ value, icon }) => {
                ...
                return (
                  <button
                    ...
                    className={`shrink-0 flex items-center gap-1.5 px-4 py-2 text-sm font-medium transition-all duration-200 whitespace-nowrap ${active === value
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <p className="text-sm text-muted mb-8">
            ...
            {active !== 'all'
              ? ` in ${locale === 'kn'
                ? categoryMeta[active as Category].labelKn
                : categoryMeta[active as Category].label
              }`
              : ''}
          </p>
          ...
          {filtered.length === 0 ? (
            ...
            w-[48%] sm:w-[30%] md:w-[22%] lg:w-[18%]
          `}
                  style={{
                    animationDelay: gridVisible ? `${index * 75}ms` : '0ms',
                  }}
                >
                  <ProductCard
                    product={product}
